...
# IMPORTANT: Save the secrets below to a secure location!
...
services:
  ...
  auth:
    ...
    environment:
      ...
      GOTRUE_DB_DATABASE_URL: postgres://postgres:${secrets.postgresPassword}@db:5432/postgres?search_path=auth
  ...
  rest:
    ...
    depends_on:
      db:
        condition: service_healthy
    environment:
      PGRST_DB_URI: postgres://postgres:${secrets.postgresPassword}@db:5432/postgres
  ...
  realtime:
    ...
    environment:
      ...
      SECRET_KEY_BASE: ${secrets.jwtSecret}
  ...
  storage:
    ...
    environment:
      ...
      DATABASE_URL: postgres://postgres:${secrets.postgresPassword}@db:5432/postgres
      PGRST_JWT_SECRET: ${secrets.jwtSecret}
  ...
  studio:
    ...
    environment:
      ...
      SUPABASE_SERVICE_KEY: ${secrets.serviceKey}
    networks:
      - lightstack
    labels:
      - "traefik.enable=true"
  ...
  meta:
    ...
    environment:
      ...
      PG_META_DB_PASSWORD: ${secrets.postgresPassword}
    networks:
      - lightstack
